...
struct ContentView: View {
    ...
    /* Paso 1.6, función de calcular IMC
       le mandamos dos parametros el peso y altura y nos regresa un string.
    */
    func calcularIMC(peso:String, altura: String) -> String {
        ...
        if let pesoDouble = Double(peso),let alturaDouble = Double(altura), alturaDouble > 0 {
            ...
            respuesta = "Ingresa valores correctos para la  altura y el peso"
        }
        return respuesta
    }
        ...
        NavigationStack{
            VStack{
                ...
                HStack{
                    ...
                    Button(action: {
                        // Paso 2.7, para guardar en SwiftData,ponemos el model y las variables a guardar
